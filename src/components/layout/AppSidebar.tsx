...
export function AppSidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className={cn(
        'flex items-center gap-3 px-4 h-16 border-b border-sidebar-border/50',
        ...
        {!collapsed && (
          <div className="flex flex-col">
            <span className="text-sm font-bold text-sidebar-foreground">SFM Digital</span>
            <span className="text-xs text-sidebar-foreground/50">Gestion Lean</span>
          </div>
        )}
      </div>
